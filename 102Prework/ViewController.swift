...
//  102Prework
//
//  Created by Cameron Rogers on 8/27/26.
//
...
class ViewController: UIViewController {
    ...
    @IBOutlet weak var yearSegmentedControls: UISegmentedControl!
    ...
    @IBAction func introduceSelfDidTapped(_ sender: UIButton) {
        ...
        let year = yearSegmentedControls.titleForSegment(
            at: yearSegmentedControls.selectedSegmentIndex
        )
